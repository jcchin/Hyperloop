...
may be related to the total tube wall temperature ($T_{t,tube}$) and the pod Mach number ($M$):
...
\begin{equation}
Q_{nat. conv} = \underbrace{ \frac{k\cdot Nu}{ {D}_{o,tube}} }_\text{$h$}
...
The mean tube temperature is 108 \degree F with a standard deviation of 12.2 \degree F.
Exceeding 138 \degree F only occurs in 5\% of the possibile scenarios generated.
